window.addEventListener("load", function () {
  ...
  form.addEventListener('submit', (e) => {
    ...
    if (description.value == '') {
      ...
      errors.push('El campo Nombre del Curso no puede estar vacío');
    } else {
      description.classList.remove('backgroundFocus')
    }
    if (language.value == '') {
      errors.push('El campo Idioma a Enseñar no puede estar vacío');
    ...
    if (week_days.value == '') {
      errors.push('El campo Días de Encuentro no puede estar vacío');
    ...
    if (topics.value == '') {
      errors.push('El campo Temática de Interes no puede estar vacío');
    ...
    if (cap_max.value == '') {
      errors.push('El campo Capacidad Máxima no puede estar vacío');
    ...
    if (link_class.value == '') {
      errors.push('El campo Link de la Plataforma no puede estar vacío');
